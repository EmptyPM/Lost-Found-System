        ...
        <div id="wrapper">
			...
			<li class="nav-item dropdown"><a
				...
				<div class="dropdown-menu" aria-labelledby="pagesDropdown">
					...
					<a class="dropdown-item" href="Manage.jsp"><i
                        ...
                        <div class="col-xl-3 col-sm-6 mb-3">
                            <div class="card  o-hidden h-100">
                                <div class="card-body">
                                    ...
                                    <div class="mr-5" ><h4  ><a href="../Locations/Locations.jsp" style="color: #000; text-decoration: none;"><i class="fas fa-map-marker-alt"></i> Locations</a></h4></div>
                                </div>
                        ...
                        <div class="col-xl-3 col-sm-6 mb-3">
                            <div class="card  o-hidden h-100">
                                <div class="card-body">
                                    ...
                                    <div class="mr-5" ><h4  ><a href="../Storage/StorageLocations.jsp" style="color: #000; text-decoration: none;"><i class="fas fa-archive"></i> Storages</a></h4></div>
                                </div>
                                <a class="card-footer clearfix small z-1" >
                        ...
                        <div class="col-xl-3 col-sm-6 mb-3">
                            <div class="card  o-hidden h-100">
                                <div class="card-body">
                                    ...
                                    <div class="mr-5" ><h4  ><a href="../Department/Department.jsp" style="color: #000; text-decoration: none;"><i class="fas fa-building"></i> Department</a></h4></div>
                                </div>
                                <a class="card-footer clearfix small z-1" >
                        ...
                        <div class="col-xl-3 col-sm-6 mb-3">
                            <div class="card  o-hidden h-100">
                                <div class="card-body">
                                    ...
                                    <div class="mr-5" ><h4  ><a href="../Category/category.jsp" style="color: #000; text-decoration: none;"><i class="fas fa-sitemap"></i> Categories</a></h4></div>
                                </div>
                                <a class="card-footer clearfix small z-1" >
                        ...
                        <div class="col-xl-3 col-sm-6 mb-3">
                            <div class="card  o-hidden h-100">
                                <div class="card-body">
                                    ...
                                    <div class="mr-5" ><h4  ><a href="../User/Users.jsp" style="color: #000; text-decoration: none;"><i class="fas fa-users"></i> Users</a></h4></div>
                                </div>
                                <a class="card-footer clearfix small z-1" >
