				...
				<div class="row">
					...
					<div class="col-xl-3 col-sm-6 mb-3">
						<div class="card text-white bg-warning o-hidden h-100">
							...
							<a class="card-footer text-white clearfix small z-1"
								href="Item/Itemfound.jsp"> <span class="float-left">Show
					...
					<div class="col-xl-3 col-sm-6 mb-3">
						<div class="card text-white bg-success o-hidden h-100">
							...
							<a class="card-footer text-white clearfix small z-1"
								href="Item/Itemreturned.jsp"> <span class="float-left">Show
									all items</span> <span class="float-right"> <i
									class="fas fa-angle-right"></i>
							</span>
							</a>
							...
							<table class="table table-bordered table-sm" id="dataTable"
								...
								<tbody>
									<tr>
										...
										<button type="button" class="btn btn-primary btn-sm"><a href="Item/Item_edit.jsp" style="text-decoration: none; color: #fff;"><i class="far fa-edit"></i> Edit</a></button></td>
									</tr>
									<tr>
										<td>02</td>
										<td>2011/07/25</td>
									...
									<tr>
										...
										<td><button class="btn btn-secondary btn-sm " data-toggle="modal" data-target="#exampleModalCenter">View</button> <button type="button" class="btn btn-primary btn-sm"><a href="Item/Item_edit.jsp" style="text-decoration: none; color: #fff;"><i class="far fa-edit"></i> Edit</a></button></td>
									</tr>
									<tr>
										<td>04</td>
										<td>2012/03/29</td>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<a class="btn btn-primary btn-sm" href="Login.jsp">Logout</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary btn-sm"><a href="Item/Item_edit.jsp" style="text-decoration: none; color: #fff;"><i class="far fa-edit"></i> Edit</a></button>
				</div>
			</div>
		</div>
	</div>
