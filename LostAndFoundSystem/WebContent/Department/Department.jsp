                                ...
                                <table class="table">
                                    ...
                                    %>
                                        <tr>
                                            ...
                                            <td></td>
                                            <td><button type="button" class="btn btn-primary"><a href="Department_edit.jsp?depId=<%=depId%>" style="text-decoration: none; color: #fff;"><i class="far fa-edit"></i>Edit</a></button></td>
                                        </tr>
                                      <%}
                        ...
                        <div class="col-xl-4 col-sm-6 mb-4">
                            <div class="card mb-3">
                                ...
                                <form action="../department_add_action" method="post" style="margin-left: 20px; margin-right: 20px; margin-bottom: 20px; margin-top: 10px;">
                                            ...
                                            <input type="text" class="form-control" id="depname" placeholder="Department ID" name="depId" required>
                                        </div>
                                   		
                                        <div class="form-group">
                                            <label for="inputEmail4">Name</label>
                                            <input type="text" class="form-control" id="depname" placeholder="Department Name" name="depName" required>
                                        </div>
                                        <div class="form-group">
