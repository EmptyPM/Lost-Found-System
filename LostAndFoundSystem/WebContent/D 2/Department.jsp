                                ...
                                <table class="table table-bordered table-sm" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Description....</td>
                                            <td><button type="button" class="btn btn-primary btn-sm"><a href="Department_edit.jsp" style="text-decoration: none; color: #fff;"><i class="far fa-edit"></i>Edit</a></button>
                            ...
                            <div class="card mb-3">
                                ...
                                <form action="" style="margin-left: 20px; margin-right: 20px; margin-bottom: 20px; margin-top: 10px;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  id="fname" placeholder="Department Name" required>
                                        </div>
                                         <div class="form-group ">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="5" id="Description"  required>Description..</textarea>
                                        </div>
