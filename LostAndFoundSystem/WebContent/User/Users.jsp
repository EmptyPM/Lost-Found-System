...
<title>Admin - Dashboard</title>
    ...
    <body id="page-top">
        ...
        <div id="wrapper">
                    ...
                    <div class="row">
                                ...
                                <table class="table table-bordered table-sm" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><button class="btn btn-secondary btn-sm " data-toggle="modal" data-target="#userview">View</button> <button type="button" class="btn btn-primary btn-sm"><a href="Users_edit.jsp" style="text-decoration: none; color: #fff;"><i class="far fa-edit"></i>Edit</a></button>
                                        ...
                                        <tr>
                                            <td>D_002</td>
                                            <td>jnyy@example.com</td>
                                            
                                            
                                            <td>Admin</td>
                                            <td><span class="badge badge-danger">Active</span>
                                        ...
                                        <tr>
                                            ...
                                            <td>Admin</td>
                                            <td><span class="badge badge-warning">Disable</span>
                        ...
                        <div class="col-xl-4 col-sm-6 mb-4">
                            <div class="card mb-3">
                                ...
                                <form action="adduser" method="post" style="margin-left: 20px; margin-right: 20px; margin-bottom: 20px; margin-top: 10px;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="E_id" placeholder="Employee Id" required >
                                    </div>
                                    <div class="form-group">
            ...
            <div class="modal fade" id="userview" tabindex="-1"
		role="dialog" aria-labelledby="userviewTitle"
		aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="ItemName">Employee Id</h5>
				...
				<h6>E ID: <span class="badge badge-light">I_001</span></h6>
				<h6>Name: <span class="badge badge-light">Tesing Name</span></h6>
				<h6>Email: <span class="badge badge-light">D@gmail.com</span></h6>
				<h6>Hotel: <span class="badge badge-light">Main Hotel</span></h6>
				<h6>Department: <span class="badge badge-light">House Keeping</span></h6>
				</div>
				<div class="col-sm-6 col-md-6 col-xl-6 col-xs-12">
				<h6>Status: <span class="badge badge-success">Active</span></h6>
				<h6>Type: <span class="badge badge-warning">Super Admin</span></h6>
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary btn-sm"><a href="Users_edit.jsp" style="text-decoration: none; color: #fff;"><i class="far fa-edit"></i> Edit</a></button>
				</div>
			</div>
		</div>
	</div>
