            ...
            <ul class="sidebar navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                        ...
                        <a class="dropdown-item" href="StorageLocations.jsp"><i class="fas fa-archive"></i> &nbsp Storage</a>
                ...
                <div class="container-fluid">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                         ...
                         <li class="breadcrumb-item active"><a href="StrorageLocation.jsp" style="text-decoration: none;">Storage</a></li>
